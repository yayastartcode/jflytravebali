...
export default function TourPackages() {
  ...
  const packages = [
    {
      id: 1,
      title: t('tourPackages.pkg1Title'),
      location: t('tourPackages.pkg1Location'),
      duration: "10",
      people: "1-3",
      price: 70,
      image: "/images/jip.jpeg",
      description: t('tourPackages.pkg1Desc'),
      featured: true,
    },
    {
      id: 2,
      title: t('tourPackages.pkg2Title'),
      location: t('tourPackages.pkg2Location'),
      duration: "10",
      people: "1-4",
      price: 65,
      image: "/images/gate.jpeg",
      description: t('tourPackages.pkg2Desc'),
      featured: false,
    },
    {
      id: 3,
      title: t('tourPackages.pkg3Title'),
      location: t('tourPackages.pkg3Location'),
      duration: "10",
      people: "included in price",
      price: 60,
      image: "/images/rmswing.webp",
      description: t('tourPackages.pkg3Desc'),
      featured: true,
    },
    {
      id: 4,
      title: t('tourPackages.pkg4Title'),
      location: t('tourPackages.pkg4Location'),
      duration: "10",
      people: "min 2 pax",
      price: 55,
      image: "/images/rmwesnusa.webp",
      description: t('tourPackages.pkg4Desc'),
      featured: false,
    },
    {
      id: 5,
      title: t('tourPackages.pkg5Title'),
      location: t('tourPackages.pkg5Location'),
      duration: "8",
      people: "2-6",
      price: 75,
      image: "/images/rmwater.webp",
      description: t('tourPackages.pkg5Desc'),
      featured: false,
    },
  ];
